...
[source,json]
----
include::{examplesdir}/{guidename}/etc/luids/archive/backends.json[]
----
...
[source,json]
----
include::{examplesdir}/{guidename}/etc/luids/archive/services.json[]
----
...
[source,toml]
----
include::{examplesdir}/{guidename}/etc/luids/archive/luarchive.toml[]
----
...
[source,json]
----
include::{examplesdir}/{guidename}/etc/luids/event/stacks.json[]
----
...
[source,toml]
----
include::{examplesdir}/{guidename}/etc/luids/event/eventproc.toml[]
----
