...
[plantuml, diagram-firewall-sequence, png,pdfwidth=60%]
....
...
[plantuml, flow-basic-firewall, png,pdfwidth=80%]
----
start
:read ip4/
...
[plantuml, flow-basic-firewall-low-confidence, png,pdfwidth=30%]
----
start
:read ip4/
:score = 0|
...
image::design-basic-nfqueue.svg[design-sinkhole,width=85%,pdfwidth=100%]
...
[plantuml, basic-nfqueue-deployment, png,pdfwidth=70%]
....
cloud "Blacklists" {
...
IMPORTANT: Puede descargar directamente los ficheros de configuración de esta guía https://github.com/luids-io/docs/blob/master/es/modules/guides/examples/basic-nfqueue[aquí].
...
[source,toml]
----
include::{examplesdir}/basic-nfqueue/etc/luids/xlist/xlget.toml[]
----
...
[source,json]
----
include::{examplesdir}/basic-nfqueue/etc/luids/xlist/services.d/low/foreign-countries.json[]
----

.Contenido de `/etc/luids/xlist/services.d/high-confidence.json`
[source,json]
----
include::{examplesdir}/basic-nfqueue/etc/luids/xlist/services.d/high-confidence.json[]
----

.Contenido de `/etc/luids/xlist/services.d/low-confidence.json`
[source,json]
----
include::{examplesdir}/basic-nfqueue/etc/luids/xlist/services.d/low-confidence.json[]
----

.Contenido de `/etc/luids/xlist/services.d/custom-local.json`
[source,json]
----
include::{examplesdir}/basic-nfqueue/etc/luids/xlist/services.d/custom-local.json[]
----

.Contenido de `/etc/luids/xlist/service.json`
[source,json]
----
include::{examplesdir}/basic-nfqueue/etc/luids/xlist/service.json[]
----
...
[source,toml]
----
include::{examplesdir}/basic-nfqueue/etc/luids/xlist/xlistd.toml[]
----
...
[source,json]
----
include::{examplesdir}/basic-nfqueue/etc/luids/apiservices.json[]
----
...
[source,toml]
----
include::{examplesdir}/basic-nfqueue/etc/luids/netfilter/lunfqueue.toml[]
----
...
[source,toml]
----
include::{examplesdir}/basic-nfqueue/etc/luids/netfilter/plugins-nfqueue.json[]
----
...
xref:lunfqueue:netfilter-integration.adoc[Integración con Netfilter].
