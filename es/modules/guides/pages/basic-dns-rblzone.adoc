...
[plantuml, antispam-rbl-positive, png,pdfwidth=100%]
....
actor "MAIL Server\n(postfix)" as postfix
...
[plantuml, flow-basic-dnsrbl, png,pdfwidth=80%]
----
start
:read ip4/
...
[plantuml, flow-basic-dnsrbl-remote, png,pdfwidth=30%]
----
start
:read ip4/
:score = 0|
...
image::design-basic-antispam.svg[design-sinkhole,width=85%,pdfwidth=100%]
...
[plantuml, basic-antispam-deployment, png,pdfwidth=70%]
....
cloud "Blacklists" {
...
[source,json]
----
include::{examplesdir}/basic-dns-rblzone/etc/luids/xlist/service.d/remote.json[]
----

.Contenido de `/etc/luids/xlist/service.d/custom-local.json`
[source,json]
----
include::{examplesdir}/basic-dns-rblzone/etc/luids/xlist/service.d/custom-local.json[]
----

.Contenido de `/etc/luids/xlist/service.json`
[source,json]
----
include::{examplesdir}/basic-dns-rblzone/etc/luids/xlist/service.json[]
----
...
[source,toml]
----
include::{examplesdir}/basic-dns-rblzone/etc/luids/xlist/xlistd.toml[]
----
