...
https://github.com/luids-io/docs/blob/master/es/modules/guides/examples/basic-dns-sinkhole[aquí].
...
[plantuml, diagram-basic-sinkhole-sequence, png, pdfwidth=70%]
----
actor dnsclient
...
[plantuml, flow-basic-dns-sinkhole, png,pdfwidth=50%]
----
start
:read domain/
:check in whitelists|
...
image::design-basic-dns-sinkhole.svg[design-sinkhole,width=85%,pdfwidth=100%]
...
[plantuml, deployment-basic-dns-sinkhole, png,pdfwidth=70%]
----
cloud "Blacklists" {
...
IMPORTANT: Recuerde que si prefiere usar `docker` también puede desplegar el escenario de esta guía https://github.com/luids-io/deploy/basic-dns-sinkhole[usando docker compose].
...
IMPORTANT: Puede descargar directamente los ficheros de configuración de esta guía https://github.com/luids-io/docs/blob/master/es/modules/guides/examples/basic-dns-sinkhole[aquí].
...
[source,toml]
----
include::{examplesdir}/basic-dns-sinkhole/etc/luids/xlist/xlget.toml[]
----
...
[source,json]
----
include::{examplesdir}/basic-dns-sinkhole/etc/luids/xlist/services.d/custom-local.json[]
----
...
[source,json]
----
include::{examplesdir}/basic-dns-sinkhole/etc/luids/xlist/service.json[]
----
...
[source,toml]
----
include::{examplesdir}/basic-dns-sinkhole/etc/luids/xlist/xlistd.toml[]
----
...
[source,json]
----
include::{examplesdir}/basic-dns-sinkhole/etc/luids/apiservices.json[]
----
