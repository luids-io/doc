...
image::design-basic-nfqueue-xlist.svg[design-sinkhole,width=85%,pdfwidth=100%]
...
[plantuml, basic-nfqueue-xlist-deployment, png,pdfwidth=70%]
....
cloud "Blacklists" {
...
[source,toml]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/xlist/xlget.toml[]
----
...
[source,json]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/xlist/services.d/low/foreign-countries.json[]
----

.Contenido de `/etc/luids/xlist/services.d/high-confidence.json`
[source,json]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/xlist/services.d/high-confidence.json[]
----

.Contenido de `/etc/luids/xlist/services.d/low-confidence.json`
[source,json]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/xlist/services.d/low-confidence.json[]
----

.Contenido de `/etc/luids/xlist/services.d/custom-local.json`
[source,json]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/xlist/services.d/custom-local.json[]
----

.Contenido de `/etc/luids/xlist/service.json`
[source,json]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/xlist/service.json[]
----
...
[source,toml]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/xlist/xlistd.toml[]
----
...
[source,json]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/apiservices.json[]
----
...
[source,toml]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/netfilter/lunfqueue.toml[]
----
...
[source,toml]
----
include::{examplesdir}/basic-nfqueue-xlist/etc/luids/netfilter/plugins-nfqueue.json[]
----
