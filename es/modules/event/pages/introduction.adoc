...
Aunque el usuario puede crear sus propios eventos, existe una base de datos con los eventos predefinidos del sistema _luIDS_ https://github.com/luids-io/event-database
