...
NOTE: ¡Enhorabuena! Ya puede presumir ante sus amigos y amigas de que ha configurado un sumidero DNS. Ahora sólo le queda (si no lo ha hecho ya) tener un hijo, escribir un libro y plantar un árbol ;).
