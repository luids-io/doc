...
El paquete de software *archive* se encuentra precompilado para los siguientes sistemas operativos y arquitecturas:
...
Puede ver todas las versiones y sus ficheros de descarga en: https://github.com/luids-io/archive/releases
...
[source,bash]
----
sudo ARCH=arm64 ./installer_archive.sh
----
...
TIP: Es posible ejecutar múltiples instancias de _luarchive_ con diferentes configuraciones. Para ello está disponible el script systemd `luids-luarchive@.service`
...
Descargue los binarios utilizando un navegador en la siguiente dirección: https://github.com/luids-io/archive/releases
...
ARCH="amd64"
DOWNLOAD_BASE="https://github.com/luids-io/archive/releases/download"
DOWNLOAD_URI="${DOWNLOAD_BASE}/v${RELEASE}/archive_${RELEASE}_${OS}_${ARCH}.tgz"
wget $DOWNLOAD_URI -O archive_binaries.tgz
tar zxvf archive_binaries.tgz
----
...
[source,bash]
----
git clone https://github.com/luids-io/archive.git
cd archive
make
----
